    ...
    <Row key={listUrl} align="center" padding="16px" id={listUrlRowHTMLId(listUrl)}>
      ...
      <Column style={{ flex: '1' }}>
        <Row>
          ...
          >
            {list.name === 'Uniswap Default List' ? 'Powerswap Default List' : list.name}
          </Text>
        </Row>
        <Row
          style={{
        ...
        >
          <StyledListUrlText title={list.name === 'Uniswap Default List' ? 'tokens.powerswap.eth' : listUrl}>
            <ListOrigin listUrl={list.name === 'Uniswap Default List' ? 'tokens.powerswap.eth' : listUrl} />
          </StyledListUrlText>
        </Row>
      </Column>
